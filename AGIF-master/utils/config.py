...
parser.add_argument('--save_dir', '-sd', type=str, default='./save/total/border/SNIPS_uncased')
parser.add_argument('--load_dir', '-ld', type=str, default=None)
# parser.add_argument('--load_dir', '-ld', type=str, default='./save/total/borderWithoutNoSlot/MixATIS_clean')
parser.add_argument('--log_dir', '-lod', type=str, default='./log/total/border/SNIPS_uncased')
...
parser.add_argument('--lambda_BIO', '-lambda3', type=int, default=4)
